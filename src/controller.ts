...
class controller {
  ...
  public async createUser(req: Request, res: Response) {
    const { firstName, middleName, lastName, email, phone, role, address } =
      req.body;
    pool.query(
      "INSERT INTO users(firstname,middlename,lastname,email,phone,role,address) VALUES ($1,$2,$3,$4,$5,$6,$7)",
  ...
  public async updateUser(req: Request, res: Response) {
    ...
    const { firstName, middleName, lastName, email, phone, role, address } =
      req.body;
    pool.query(
      "UPDATE users SET firstname = $1, middlename = $2, lastname = $3, email = $4, phone = $5, role = $6, address = $7 WHERE id = $8",
